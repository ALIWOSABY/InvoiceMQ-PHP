...
';
  ...
  <link rel="stylesheet" href="../Assets/css/style.css" />  
    <table  width="100%" style="direction:rtl;" height="30%" >                              
                                  <tr class="haed_acc" style="text-align: center;">                               
                                      <th class="haed_acc"  width="50%"   style="text-align: center;">التأريخ</th>                                                                   
                                      <th class="haed_acc" width="50%" style="text-align: center;">الملاحظة</th>                                              
                                      ';
  $html1 .= '</tr></thead><tbody>';
  $html1 .= '<tr>             


  <td width="50%"  style="text-align: center;font-size:10px;font-weight:bold;">' . date("d-m-Y", strtotime($VTS_date)) . '</td>       
  <td  width="50%" width="12%"  style="text-align: center;font-size:10px;font-weight:bold;">' . $VTS_NT . '</td>';
  ...
  $sqlOne = mysqli_query($conn, "SELECT s.TSTOTSALE, s.TS_SER,days.DY_name, s.TS_NUM, s.TS_PRC, s.TS_TOT, s.TS_DISC,s.TSTOTDISC,
  s.TSNT, s.TSDAT,s.TSMUS,days.DY_ID, days.DY_name,(SELECT COUNT(*) 
  FROM tn_s s2 WHERE s2.TS_V_ID = s.TS_V_ID) FROM tn_s s,`days` Where TS_DY= DY_ID and TS_V_ID =$vou_id;");
  ...
  <link rel="stylesheet" href="../Assets/css/style.css" />   
    <table  width="100%" style="direction:rtl;" height="30%" >                    
                                  ...
                                  <th class="haed_acc" colspan="5"  width="20%"  style="text-align: center;">الملاحظات</th> 
                                      ';
  $html2 .= '</tr><tbody>';
  $tmpAlbum = '';
  while ($rsupa = mysqli_fetch_array($sqlOne)) {
    $html2 .= '<tr>                     
      ...
      <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">' . $rsupa['TS_PRC'] . '</td>';
    if ($rsupa[0] != $tmpAlbum || $rsupa[0] == '0') {
      $html2 .= '<td width="15%"  style="text-align: center;font-size:10px;font-weight:bold;" rowspan=\'' . $rsupa[13] . '\'>' . $rsupa['TSTOTSALE'] . '</td>';
      $html2 .= '<td width="15%"  style="text-align: center;font-size:10px;font-weight:bold;" rowspan=\'' . $rsupa[13] . '\'>' . $rsupa['TSMUS'] . '</td>';
    }

    $html2 .= '
    <td  width="20%" colspan="5"  style="text-align: center;font-size:10px;font-weight:bold;">' . $rsupa['TSNT'] . '</td>';
    $tmpAlbum = $rsupa[0];
    $html2 .= '</tr>';
    $html2 .= '</tbody>';
  }
  ...
  $html2 .= '<tr>       
          ...
          <td   class="tabh"></td>
          <td   class="tabh"></td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">نسبة التخفيض</td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:red;">' . $TSITOTRET . '</td>
          <td   class="tabh"></td>
          <td  class="tabh"></td>
          <td   class="tabh"></td>';
  $html2 .= '</tr>';
  $html2 .= '<tr>       
          ...
          <td   class="tabh"></td>
          <td   class="tabh"></td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">الصافي</td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:red;">' . $TSTOTSALE . '</td>
          <td   class="tabh"></td>
          <td  class="tabh"></td>
          <td   class="tabh"></td>';
  $html2 .= '</tr>';
  $html2 .= '<tr>       
          ...
          <td   class="tabh"></td>
          <td   class="tabh"></td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">المسلم</td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:black;">' . $TSMUS . '</td>
          <td   class="tabh"></td>
          <td  class="tabh"></td>
          <td   class="tabh"></td>';
  ...
  $html2 .= '<tr>       
          ...
          <td   class="tabh"></td>
          <td   class="tabh"></td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">المتبقى له</td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:red;">' . $TSHISREMD . '</td>
          <td   class="tabh"></td>
          <td  class="tabh"></td>
          <td   class="tabh"></td>';
  ...
  $html2 .= '<tr>       
          ...
          <td   class="tabh"></td>
          <td   class="tabh"></td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">المتبقى عليه</td>
          <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:red;">' . $TSONREMD . '</td>
          <td   class="tabh"></td>
          <td  class="tabh"></td>
          <td   class="tabh"></td>';
  $html2 .= '</tr></tfoot>';
...
if ($_POST['methode'] == "pnt_all_vts") {
  ...
  while ($rlt1 = mysqli_fetch_array($sql_one)) {
    ...
    s.TSNT, s.TSDAT,s.TSMUS,days.DY_ID, days.DY_name,(SELECT COUNT(*) 
    FROM tn_s s2 WHERE s2.TS_V_ID = s.TS_V_ID) FROM tn_s s,`days` Where TS_DY= DY_ID and TS_V_ID =$VOUID;");
    ...
    $html1 = '  
      ...
      <link rel="stylesheet" href="../Assets/css/style.css" />  
        ...
        <tr class="haed_acc">                                        
        <th class="haed_acc" colspan="1" width="20%" style="text-align: center;">تاريخ العملية</th>
        <th class="haed_acc" width="20%" colspan="2">' . date("d-m-Y", strtotime($rlt1['VS_DAT'])) . '</th>
        <th class="haed_acc" colspan="1" width="15%" style="text-align: center;">اسم المورد</div></th>                                                                                                                    
        ...
        <th class="haed_acc" width="20%" style="text-align: center;" colspan="5">' . $rlt1['VS_NT'] . '</th>
            ...
            <th class="haed_acc"  width="15%"  style="text-align: center;">اجمالي بعد الخصم</th>
            <th class="haed_acc"  width="15%"  style="text-align: center;">المسلم</th>
            <th class="haed_acc" colspan="6"  width="20%"  style="text-align: center;">الملاحظات</th> 
              ';
    $html1 .= '</tr><tbody>';
    $tmpAlbum = '';
    while ($rsupa = mysqli_fetch_array($sql_two)) {
      ...
      if ($rsupa[0] != $tmpAlbum || $rsupa[0] == '0') {
        $html1 .= '<td width="15%"  style="text-align: center;font-size:10px;font-weight:bold;" rowspan=\'' . $rsupa[13] . '\'>' . $rsupa['TSTOTSALE'] . '</td>';
        $html1 .= '<td width="15%"  style="text-align: center;font-size:10px;font-weight:bold;" rowspan=\'' . $rsupa[13] . '\'>' . $rsupa['TSMUS'] . '</td>';
      }

      $html1 .= '
      <td   width="20%"  colspan="6"  style="text-align: center;font-size:10px;font-weight:bold;">' . $rsupa['TSNT'] . '</td>';
      $tmpAlbum = $rsupa[0]; 
      $html1 .= '</tr>';     
    }
...
if ($_POST['methode'] == "get_id_supprcomp") {
  ...
  $html1 = '
      ...
      <link rel="stylesheet" href="../Assets/css/style.css" />  
        ...
        <tr class="haed_acc">                                               
        <th class="haed_acc" colspan="2" width="20%" style="text-align: center;">اسم المورد</div></th>                                                                                                                    
        <th class="haed_acc" width="30%" style="text-align: center;" colspan="3">' . $Nsup  . '</th>                                                                                                        
        <th class="haed_acc" width="10%" style="text-align: center;" colspan="1">البيان</th>
        <th class="haed_acc" width="40%" style="text-align: center;" colspan="5">' . $Nvnot  . '</th>
    </tr>
  ...
  while ($rsupa = mysqli_fetch_array($sql_two)) {
    ...
    if ($rsupa[0] != $tmpAlbum || $rsupa[0] == '0') {
      ...
      $html1 .= '<td width="15%"  style="text-align: center;font-size:10px;font-weight:bold;" rowspan=\'' . $rsupa[15] . '\'>' . $rsupa['TSMUS'] . '</td>';
    }
  ...
  <td   class="tabh"></td>
  <td   class="tabh"></td>
  <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">اجمالي المسلم</td>
  <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:black;">' . $TSMUS . '</td>
  <td   class="tabh"></td>
  <td   class="tabh"></td>';
  ...
  <td   class="tabh"></td>
  <td   class="tabh"></td>
  <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;">الفلوس الموصله</td>
  <td   width="15%"  style="text-align: center;font-size:10px;font-weight:bold;color:red;">' . $DLIVAMNT . '</td>
  <td   class="tabh"></td>
  <td   class="tabh"></td>';
  $html1 .= '</tr></tfoot>';
  $html1 .= '</table>';
