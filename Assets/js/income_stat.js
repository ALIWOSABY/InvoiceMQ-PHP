...
$(document).ready(function () {
    ...
    var frm_income_stat = $("#frm_income_stat").validate({
        rules: {
            i_date1: {
                required: true
            },
    ...
    $('#pnt_income_stat_acc').click(function () {
        // alert('Mizan Account');

        if ($('#frm_income_stat').valid()) {
            ...
            if (income_stat_TYP == 1) {
                $.ajax({
                    type: "POST",
                    url: "../../Controllers/income_stat_Controller.php",
                    data: "method=print_income_stat1_all&i_date1=" + i_date1 + "&i_date2=" + i_date2 + "&VOU_USE_name=" + VOU_USE_name + "&income_stat_ACC_LEV_F=" + income_stat_ACC_LEV_F + "&income_stat_ACC_LEV_T=" + income_stat_ACC_LEV_T + "",
                ...
                $.ajax({
                    type: "POST",
                    url: "../../Controllers/income_stat_Controller.php",
                    data: "method=print_income_stat2_all&i_date1=" + i_date1 + "&i_date2=" + i_date2 + "&VOU_USE_name=" + VOU_USE_name + "&income_stat_ACC_LEV_F=" + income_stat_ACC_LEV_F + "&income_stat_ACC_LEV_T=" + income_stat_ACC_LEV_T + "",
                    success: function (result) {
                        // alert(result);
                        window.open(result, "resizeable,scrollbar");
                    }
