            ...
            <table id="Tb_Csut_ID" class="table table-bordered table-striped" style="text-align: center;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;width:10%;">اسم المستند</th>
                ...
                <tbody>
                    ...
                    foreach ($invListcust as $Detcust) {
                        $Datecust = date("d-m-Y", strtotime($Detcust["VS_DAT"]));
                        echo '
                                <tr>
                                    <td>' . $Detcust["VS_ID"] . '</td>
                                    <td>' .   $Datecust . '</td>
                                    <td>' . $Detcust["TYP_NAME"] . '</td>
                                    <td>' . $Detcust["SYS_User_name"] . '</td>   
                                    <td>' . $Detcust["VS_NT"] . '</td>
                                                                                                      
                                  ';

                        switch ($Detcust["VS_ST"]) {
                            case '0':
                        ...
                        if (isset($row['SEC_USE_ID'])) {
                            echo '
                                    ...
                                    <a id="edit_trans_voucher" data-voucher="' . $Detcust["VS_ID"] . '" href="?page=p_edit_cust_vt&updatecust_id=' . $Detcust["VS_ID"] . '" data-toggle="tooltip" data-placement="top" title="تعديل" class="btn bg-olive"><span class="glyphicon glyphicon-edit"> تعديل البيانات </span></a></li>';
                        } else {
                        ...
                        if (isset($row['SEC_USE_ID'])) {
                            ...
                            echo '
                                    <a href="?page=p_v_cust_vt&updatecust_id=' . $Detcust["VS_ID"] . '"  data-toggle="tooltip" data-placement="top" title="عرض" class="btn bg-olive"><span class="glyphicon glyphicon-eye-open"> عرض البيانات </span></a></li>';
                        } else {
                            echo '
                        ...
                        if (isset($row['SEC_USE_ID'])) {
                            ...
                            echo '
                                    <a href="#" id="' . $Detcust["VS_ID"] . '" class="deleterecords_move  btn bg-olive"  data-toggle="tooltip" data-placement="top" title="حــذف"><span class="glyphicon glyphicon-remove"> حــذف السـجل </span></a></li>';
                        } else {
                        ...
                        echo '<a href="#" id="' . $Detcust["VS_ID"] . '" TCTOTSALE="' . $Detcust["TCTOTSALE"] . '" TCMUS="' . $Detcust["TCMUS"] . '"  data-toggle="tooltip" data-placement="top" title="تحويل" class="trans_status_cust btn bg-olive" data-toggle="modal"><span class="glyphicon glyphicon-transfer"> نقل السجل </span></a></li>';
                        ...
                        echo '
                        <li>                                                            
                        <a href="#" id="PrintdataVTCustU"  data-toggle="tooltip" data-placement="top" title="طباعة القيد" VS_ID="' . $Detcust["VS_ID"] . '" VOU_USE_name="' . $ens[0]->getSYS_User_name() . '"  VS_TYP_ID="' . $Detcust["VS_TYP_ID"] . '" VS_ST="' . $Detcust["VS_ST"] . '" " class="btn bg-olive"><span class="glyphicon glyphicon-print"> طباعة القيد </span></a>                                                                    
                        </li>
