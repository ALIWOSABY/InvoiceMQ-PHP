                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php for ($s = 0; $s < count($Acc); $s++) {
                                            if ($aff[$i]->getAnalytic_Acc_id() == $Acc[$s]->getCUS_ID()) {
                                        ?>
                                                <td> <?php echo $Acc[$s]->getCUS_NAME(); ?></td>
                                                <td> <?php echo $Acc[$s]->getCUS_NAMEE(); ?></td>
                                        <?php }
                                        } ?>

                                        <!-- ?php for ($b = 0; $b < count($x); $b++) {
                                            if ($aff[$i]->getUSE_BRA_ID() == $x[$b]->getBranch_id()) {
                                        ?>
                                                <td> ?php echo $x[$b]->getBranch_desc(); ?></td>
                                        ?php }
                                        } ?> -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="Add_Analytic_Acc_id" id="Add_Analytic_Acc_id" class="form-control">
                                    <option value="">تحديد </option>
                                    <?php
                                    for ($i = 0; $i < count($n); $i++) {

                                        echo '<option value="' . $n[$i]->getCUS_ID() . '">' . $n[$i]->getCUS_NAME() . '</option>';
                                    }
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="Add_USE_BRA_ID" id="Add_USE_BRA_ID" class="form-control">
                                    ...
                                    <!-- ?php
                                    for ($i = 0; $i < count($x); $i++) {
                                        if ($x[$i]->getBRA_FREEZE() == 'Y') {

                                            echo '<option value="' . $x[$i]->getBranch_id() . '">' . $x[$i]->getBranch_desc() . '</option>';
                                        }
                                    }
                                    ?> -->
                                </select>
            ...
            <div class="modal-body">
                ...
                <form action="" id="form_edit_inactive" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group">
                                <label>اسم المستخدم(عربي) :</label>
                                <input type="text" name="SYS_User_name" id="SYS_User_name" class="form-control"
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input style="text-align: left;" type="text" name="USE_NAMEE" id="USE_NAMEE"
                                    class="form-control" placeholder="اسم المستخدم (انجليزي)">

                            </div>
                        </div> -->

                        <!-- <div class="form-group">
                        <input type="number" name="USE_PARENT_ID" id="USE_PARENT_ID" class="form-control"
                            placeholder=" المستخدم الاب">
                        ...
                        <!-- <div class="col-md-6">
                            <div class="form-group">
                                <label>مدير الإدارة:</label>
                                <select name="USE_PARENT_ID" id="USE_PARENT_ID" class="form-control"></select>
                            </div>
                        </div> -->
